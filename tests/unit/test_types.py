...
class TestAddress(unittest.TestCase):
    ...
    def test_valid(self):
        assert Address(address=self.lower_case_address).address == "0xde1c59bc25d806ad9ddcbe246c4b5e5505645718"
        assert Address(address=self.check_sum_address).address == "0xdef1ca1fb7fbcdc777520aa7f396b4e015f497ab"
        assert Address(address=self.dune_format).address == "0x5d4020b9261f01b6f8a45db929704b0ad6f5e9e6"
...
class TestQueryParameter(unittest.TestCase):
    ...
    def test_constructors_and_to_dict(self):
        ...
        assert self.date_type.to_dict() == {"key": "Date", "type": "datetime", "value": "2022-03-10 00:00:00"}
    ...
    def test_repr_method(self):
        ...
        assert str(query) == "QueryBase(query_id=1, name='Test Query', " "params=[" "Parameter(name=Number, value=1, type=number), " "Parameter(name=Text, value=hello, type=text)" "])"
